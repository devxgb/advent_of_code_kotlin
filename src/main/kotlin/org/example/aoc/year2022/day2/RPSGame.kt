...
class RPSGame {
    ...
    enum class ResultPair(val resultPlayer1: Result, val resultPlayer2: Result) {
        PLAYER1_WINS(Result.WIN, Result.LOSS), PLAYER2_WINS(Result.LOSS, Result.WIN), GAME_DRAW(
            Result.DRAW,
            Result.DRAW
        )
    }
    ...
    companion object {
        private val RULE_TABLE = hashMapOf(
            ROCK to hashMapOf(
                ROCK to GAME_DRAW,
                PAPER to PLAYER2_WINS,
                SCISSORS to PLAYER1_WINS
            ),
            PAPER to hashMapOf(
                ROCK to PLAYER1_WINS,
                PAPER to GAME_DRAW,
                SCISSORS to PLAYER2_WINS
            ),
            SCISSORS to hashMapOf(
                ROCK to PLAYER2_WINS,
                PAPER to PLAYER1_WINS,
                SCISSORS to GAME_DRAW
            )
        )

        private val REVERSE_LOOKUP_RULE_TABLE = hashMapOf(
            ROCK to hashMapOf(
                GAME_DRAW to ROCK,
                PLAYER2_WINS to PAPER,
                PLAYER1_WINS to SCISSORS
            ),
            PAPER to hashMapOf(
                PLAYER1_WINS to ROCK,
                GAME_DRAW to PAPER,
                PLAYER2_WINS to SCISSORS
            ),
            SCISSORS to hashMapOf(
                PLAYER2_WINS to ROCK,
                PLAYER1_WINS to PAPER,
                GAME_DRAW to SCISSORS
            )
        )
    }
